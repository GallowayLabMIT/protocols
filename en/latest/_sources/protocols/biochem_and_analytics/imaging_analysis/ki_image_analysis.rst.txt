...
.. important:: 
    ...
    This protocol is supplemental only to training provided by the core staff, and aimed mainly for basic 3D reconstruction using Z-stack images. 
...
3. Double click on your Project. It should automatically open in the LasX software (the same software used for Image acquisition in the Sp8).
...
7. Once satisfied with the 3D model, you can click on the Measurement tab to obtain 3D metrics including Volume. 
...
4. The cropped image will display the metrics such as Volume and Area which you can confirm from the data measured from LasX software. 
