...
.. note::
	If performing transient transfection for virus production: please use the updated :doc:`/protocols/tc/virus/virus_production` protocol for lentivirus production via HEK293Ts, and the :doc:`/protocols/tc/virus/platE_transfection` protocol for Plat-E retrovirus production.
