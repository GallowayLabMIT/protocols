...
1. **Generating fragments.** These steps take in all of the chromatin (or intact nuclei, or cells) and somehow fragment the DNA.
2. **Post-fragment methods.** Fragments of interest can be selected and enriched.
...
=========   ===================     ==================     ==========  ==============
Chip         Sonication             Antibody pulldown      Ligation    N/A
=========   ===================     ==================     ==========  ==============
...
2. **Split-pool methods** which do successive rounds where cells are split across multiple PCR plates, then re-pooled and split again.
...
simultaneously. NGS is a "short-read" sequencing method because each of the molecules are not read in full; only
...
..anything that you can place PCR adapters onto.
