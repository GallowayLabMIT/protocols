...
As a pHA, pKG3198 is compatible with existing pPV2s for BsaI golden gate cloning. The polyA is encoded on the plasmid so the IVT template is generated by via restriction digestion and the IVT is done differently
