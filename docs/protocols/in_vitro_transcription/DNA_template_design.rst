...
Creating a new IVT template plasmid - NEED TO UPDATE
===========================================================

.. warning:: 
  This needs to be updated (2/25/2025 - NBW)

As a pHA, pKG3198 is compatible with existing pPV2s for BsaI golden gate cloning. The polyA is encoded on the plasmid so the IVT template is generated by via restriction digestion.
...
.. note:: 
  Use filter tips
  Spray down area with obliterase beforehand but not once you're working with DNA because you don't want to digest your template DNA
...
2. Run 2-4 hours at 37°C (normally 4 hours)
3. Add 30 µL water and 2 µL DNase I to digest DNA
4. Run 30 min at 37°C and purify
