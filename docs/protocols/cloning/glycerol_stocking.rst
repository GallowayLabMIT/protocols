...
.. note:: 
    ...
    For personal glycerol stocks (e.g., plasmids waiting to be tested in TC before adding to the database), one vial per plasmid is sufficient.
    These can be stored in personal boxes in the -80ºC.
